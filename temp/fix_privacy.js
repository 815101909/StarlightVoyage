    ...
    return [
      {
        title: "1. 信息收集",
        paragraphs: [
          "晓视界（以下简称\"我们\"）尊重并保护所有用户的个人隐私权。为了给您提供更准确、更有个性化的服务，我们会按照本隐私政策的规定使用和披露您的个人信息。",
    ...
    return [
      {
        title: "1. 接受条款",
        paragraphs: [
          "欢迎您使用晓视界！在使用我们的服务之前，请您仔细阅读并同意以下条款。",
          "本协议是您与晓视界之间关于使用晓视界服务所订立的协议。通过访问或使用本应用，您表示您接受并同意受本协议的约束。"
        ]
      },
      {
        title: "2. 账户注册与安全",
        paragraphs: [
          "在使用本服务前，您需要注册一个晓视界账户。您在注册过程中提供的所有信息必须是真实、准确、完整和最新的。",
      ...
      },
      {
        title: "4. 知识产权",
        paragraphs: [
          "晓视界及其相关的所有权利（包括但不限于版权、商标权、专利权、商业秘密等）均归我们或我们的授权方所有。",
          "未经我们明确书面许可，您不得以任何形式复制、修改、出版、发行、公开展示或利用晓视界的内容或服务。"
        ]
      },
      {
        title: "5. 免责声明",
        paragraphs: [
          ...
          "对于因不可抗力或晓视界不能控制的原因造成的服务中断或其他缺陷，晓视界不承担任何责任。"
        ]
      },
      {
        title: "6. 协议修改",
        paragraphs: [
          ...
          "如果您不同意修改后的条款，您有权停止使用晓视界的服务。如果您继续使用服务，则视为您接受修改后的协议。"
        ]
      },
      {
        title: "7. 法律适用与争议解决",
        paragraphs: [
          ...
          "如双方就本协议内容或其执行发生任何争议，双方应尽量友好协商解决；协商不成时，任何一方均可向晓视界所在地的人民法院提起诉讼。"
        ]
      }
    ];
  }
